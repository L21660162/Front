...
export type ICreateBuildingMutation = { createBuilding: { _id: string, createdAt?: any | null, deletedAt?: any | null, isDeleted: boolean, letter?: string | null, name: string, updatedAt?: any | null } };
...
export type ICreateClassroomMutation = { createClassroom: { _id: string, building: string, createdAt?: any | null, deletedAt?: any | null, identifier: string, isDeleted: boolean, updatedAt?: any | null } };
...
export type IGetAllSchedulesQuery = { getAllSchedules: { hasNextPage: boolean, hasPrevPage: boolean, limit: number, nextPage?: number | null, offset?: number | null, page: number, pagingCounter: number, prevPage?: number | null, totalDocs: number, totalPages: number, docs: Array<{ _id: string, classGroup: string, classroom: string, createdAt?: any | null, deletedAt?: any | null, finalTime: any, isDeleted: boolean, period: string, startTime: any, subject: string, teacher: string, updatedAt?: any | null, weekday: number }> } };
...
export type IGetScheduleByIdQuery = { getScheduleById: { _id: string, classGroup: string, classroom: string, createdAt?: any | null, deletedAt?: any | null, finalTime: any, isDeleted: boolean, period: string, startTime: any, subject: string, teacher: string, updatedAt?: any | null, weekday: number } };
...
export const GetAllDepartmentsDocument = /*#__PURE__*/ `
    query GetAllDepartments($filter: DepartmentArgs, $limit: Int, $offset: Int, $page: Int) {
  getAllDepartments(filter: $filter, limit: $limit, offset: $offset, page: $page) {
    docs {
      _id
      areaKey
      createdAt
