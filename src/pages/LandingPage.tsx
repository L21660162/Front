      ...
      <div id="home" className="landing-wrapper overflow-hidden">
        <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
          <Link to="/" className="flex align-items-center">
            ...
            />
            <span className="text-900 font-medium text-2xl line-height-3 mr-8">NAVI</span>
          </Link>
          <StyleClass
        ...
        >
          <div className="mx-4 md:mx-8 mt-0 md:mt-4">
            <h1 className="text-6xl font-bold text-gray-900 line-height-2">
              <span className="font-light block">Eu sem integer</span>
            ...
            <div className="col-12 md:col-2" style={{ marginTop: '-1.5rem' }}>
              ...
              >
                <img
                  ...
                  className="mr-2"
                />
                <span className="font-medium text-3xl text-900">NAVI</span>
              </Link>
            </div>
