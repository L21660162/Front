  ...
  const { mutate } = usePasswordRecoveryMutation<IApiError>(GRAPHQL_CLIENT, {
    onSuccess: () => {
      toast.current?.show({
        ...
        detail: t('global.toast.success.detail.passwordRecoverySuccess'),
      });
  ...
  return (
    <div className={containerClassName}>
      ...
      <div className="flex flex-column align-items-center justify-content-center">
        <img src={logo} alt="ITMH logo" className="mb-5 w-6rem flex-shrink-0" />
        <div
          style={{
            borderRadius: '56px',
            padding: '0.3rem',
        ...
        >
          <div className="w-full surface-card py-5 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
            <div className="text-center mb-5">
              ...
              <span className="text-600 font-medium">{t('passwordRecovery.message')}</span>
            </div>
